...
class HermesApi {
  ...
  const HermesApi(this._dio, this._serializers);
  ...
  Future<Response<JsonObject>> chatCompletionsHermesChatCompletionsPost({ 
    String? X_API_TOKEN,
    ...
    final _path = r'/hermes/chat/completions';
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltMap<String, JsonObject>>> hermesHealthCheckHermesHealthGet({ 
    String? X_API_TOKEN,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
