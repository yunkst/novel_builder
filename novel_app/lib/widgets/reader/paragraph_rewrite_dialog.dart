...
class _RewriteInputDialogState extends State<_RewriteInputDialog> {
  ...
  Future<void> _openHistory() async {
    ...
    setState(() {
      _controller.text = selection.promptText;
      _controller.selection = TextSelection.fromPosition(
        TextPosition(offset: selection.promptText.length),
      );
      _groups = selection.tagGroups;
    });
  }
            ...
            if (_groups.isNotEmpty)
              Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                      fontSize: 12, color: context.appColors.onInfoContainer),
                ),
              ),
          ],
        ),
