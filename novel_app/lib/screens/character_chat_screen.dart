...
class _DarkThemeColors {
  ...
  static const Color roleBubbleBorder = Color(0xFF3D5A80);
  static const Color roleAvatarBorder = Color(0xFF3D5A80);
  static const Color roleAvatarBackground = Color(0xFF1E3A5F);
