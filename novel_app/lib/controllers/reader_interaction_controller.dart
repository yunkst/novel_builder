...
class ReaderInteractionController {
 ...
 'ReaderInteractionController: 特写模式下不处理长按',
 ...
 return _ref
 .read(interactionStateNotifierProvider.notifier)
 .getSelectedText(paragraphs);
 }

 // ========== Getters ==========

 /// 是否在特写模式（从Provider获取）
 bool get isCloseupMode =>
 _ref.read(interactionStateNotifierProvider).isCloseupMode;
 ...
 _ref.read(interactionStateNotifierProvider).hasSelection;

 ///选中段落数量（从Provider获取）
 int get selectionCount =>
 _ref.read(interactionStateNotifierProvider).selectionCount;
}