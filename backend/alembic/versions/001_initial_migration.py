...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_novel_chapters_cache_id"), "novel_chapters_cache", ["id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_novel_chapters_cache_chapter_index"),
        "novel_chapters_cache",
        ["chapter_index"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_novel_chapters_cache_chapter_index"), table_name="novel_chapters_cache"
    )
    op.drop_index(
        op.f("ix_novel_chapters_cache_task_id"), table_name="novel_chapters_cache"
    )
    ...
    op.drop_index(
        op.f("ix_novel_cache_tasks_novel_url"), table_name="novel_cache_tasks"
    )
