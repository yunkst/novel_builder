...
**界面展示**：
![书架界面](../novel_app/docs/images/interfaces/bookshelf.png)
...
**界面展示**：
![阅读界面](../novel_app/docs/images/interfaces/reader.png)
...
- **Hermes Agent**: 基于OpenAI兼容API的智能对话助手，支持单角色/多角色聊天
