...
- **🧠 智能内容生成**: DSL Engine 本地工作流 + AI Agent 智能对话
...
**界面展示**：
![AI 助手](../novel_app/docs/images/interfaces/20-ai-assistant.png)

**核心功能**：

- **💎 全局浮窗入口**: 左下角紫色星星按钮可随时呼出 AI 助手
...
**AI 智能对话**：
```
阅读过程中 → 点击左下角紫色星星 → 呼出 AI 助手 → 输入问题 → 流式获得回答
```
...
| **场景体验** | 文字描述 | 动态插图和视频 |
| **内容创作** | 只能阅读 | 支持用户创作和插入 |
| **AI 辅助** | 无 | DSL Engine + AI Agent 双引擎 |
| **离线阅读** | 部分支持 | 智能分层缓存 |
